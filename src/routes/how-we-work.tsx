          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              <a
                ...
                style={{
                  boxShadow:
                    "0 20px 40px -12px rgba(0, 136, 255, 0.5)",
                }}
              >
                Book a Demo
  ...
  return (
    <div className="relative h-48 w-full overflow-hidden rounded-lg bg-[#0A1628]">
      <svg viewBox="0 0 320 180" className="h-full w-full">
        ...
        {/* Architecture blocks */}
        <g>
          <rect x="40" y="30" width="80" height="40" rx="4" fill="none" stroke="#0088FF" strokeWidth="1.5" />
          <text x="80" y="55" textAnchor="middle" fill="#93C5FD" fontSize="9" fontFamily="monospace">DASHBOARD</text>

          <rect x="200" y="30" width="80" height="40" rx="4" fill="none" stroke="#0088FF" strokeWidth="1.5" />
          <text x="240" y="55" textAnchor="middle" fill="#93C5FD" fontSize="9" fontFamily="monospace">AI VOICE</text>

          <rect x="40" y="110" width="80" height="40" rx="4" fill="none" stroke="#0088FF" strokeWidth="1.5" />
          <text x="80" y="135" textAnchor="middle" fill="#93C5FD" fontSize="9" fontFamily="monospace">PIPELINES</text>

          <rect x="200" y="110" width="80" height="40" rx="4" fill="none" stroke="#0088FF" strokeWidth="1.5" />
          <text x="240" y="135" textAnchor="middle" fill="#93C5FD" fontSize="9" fontFamily="monospace">AUTOMATIONS</text>

          {/* Center hub */}
          <circle cx="160" cy="90" r="14" fill="#0088FF" />
          <circle cx="160" cy="90" r="20" fill="none" stroke="#0088FF" strokeWidth="1" opacity="0.6" />

          {/* Connections */}
          <line x1="120" y1="50" x2="148" y2="82" stroke="#0088FF" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="200" y1="50" x2="172" y2="82" stroke="#0088FF" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="120" y1="130" x2="148" y2="98" stroke="#0088FF" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="200" y1="130" x2="172" y2="98" stroke="#0088FF" strokeWidth="1" strokeDasharray="3 3" />
        </g>
      </svg>
    </div>
  );
