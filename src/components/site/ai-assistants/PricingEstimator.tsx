...
const TIERS: TierExt[] = [
  {
    ...
    features: [
      ...
      { label: "Smart Call Routing (blind & warm transfers)", included: true },
      { label: "After-Hours Rules & Escalation", included: true },
      { label: "Spam Detection & Call Blocking", included: true },
      { label: "Call Recordings & Full AI Summary", included: true },
      { label: "Caller Intent Detection (what they called about)", included: true },
      { label: "Live Follow-Up Alerts (email after every call)", included: true },
      { label: "Done-For-You Setup & Management", included: true },
      { label: "30-Day Money-Back Guarantee", included: true },
      { label: "Intake Form Delivery", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Intake Form Delivery (send forms mid-call or post-call)", included: true, emphasize: true },
      { label: "Email AI Assistant (200 replies/mo)", included: true, emphasize: true },
      { label: "Analytics Dashboard (call volume, top reasons, outcomes)", included: true, emphasize: true },
      { label: "Monthly Performance Report", included: true },
      { label: "Calendar Sync", included: false },
      { label: "Bilingual Support", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Full Analytics Dashboard (all metrics, trends, top questions)", included: true, emphasize: true },
      { label: "Lead Scoring (Hot / Warm / Cold — auto-tagged on every call)", included: true, emphasize: true },
      { label: "Auto Follow-Up Email (with custom links)", included: true },
      { label: "Calendar Sync (Google & Outlook)", included: true },
      { label: "Caller Memory (remembers past callers by number)", included: true },
      { label: "Bilingual Support (EN/ES)", included: true },
      { label: "Call Volume by Time of Day Report", included: true },
      { label: "Most Asked Questions Report", included: true },
